...
function SubmitButton({ busy, icon, busyText, children }) {
  return (
    <button
      type="submit"
      disabled={busy}
        ...
        <section className="grid gap-5 xl:grid-cols-3">
          <form onSubmit={submitYoutube} className="rounded-2xl border border-line bg-surface-card p-5">
            ...
            <div className="grid gap-4">
              ...
              <SubmitButton busy={ingestMutation.isPending} icon="rocket" busyText="Creating...">
          ...
          <form onSubmit={submitUrl} className="rounded-2xl border border-line bg-surface-card p-5">
            ...
            <div className="grid gap-4">
              ...
              <SubmitButton busy={ingestUrlMutation.isPending} icon="link" busyText="Importing...">
                Import Recording
              </SubmitButton>
            </div>
          </form>
          ...
          <form onSubmit={submitUpload} className="rounded-2xl border border-line bg-surface-card p-5">
            ...
            <div className="grid gap-4">
              ...
              <SubmitButton busy={uploadMutation.isPending} icon="upload" busyText="Uploading...">
                Upload and Process
              </SubmitButton>
            </div>
          </form>
